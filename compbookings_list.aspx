<%@ Page Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="compbookings_list.aspx.vb" Inherits="compbookings_list" %>
<asp:Content ContentPlaceHolderId="html_body" runat="server">
   <div id="content">
      <div id="content-header">
         ...
         <h1>Paid Booking List with F & B</h1>
      </div>
      <div class="container">
         <div class="span6">
            <label>
      ...
      //	var eventidpsl = $("#event_list option:selected").attr("eid");
         ...
         // alert(todate);
      	//alert(eventidpsl);
                ...
                type: "get",
                async:false,
               data: { type: "36",  eventidpsl: eventidpsl },
                success: function (res) {
      	   ...
      	   var tabcontent = "";
      	    ...
      	    if (res.total.length > 0) {
                    ...
                    tabcontent += " </tr>"
						...
						{
						//alert(res.total[i].Ticketname);;
						if(res.total[i].Ticketname.indexOf('Comp') == 0 )
      					{
      					var sold=0;
      					var total=res.total[i].Total_tickets;
