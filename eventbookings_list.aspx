<%@ Page Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="eventbookings_list.aspx.vb" Inherits="eventbookings_list" %>
   ...
   <script type="text/javascript">
	 ...
	 load_allmatches();
	   ...
	   function load_allmatchesbyfilter(filterpsl) {
                ...
                type: "get",
                async:false,
               data: { type: "27",filterpsl: filterpsl},
         ...
         // alert(todate);
      	//alert(eventidpsl);
      	  ...
      	  // alert(eventidpsl);
                ...
                type: "get",
                async:false,
               data: { type: "28",  eventidpsl: eventidpsl },
                success: function (res) {
