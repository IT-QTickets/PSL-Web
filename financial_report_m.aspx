<%@ Page Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="financial_report_m.aspx.vb" Inherits="financial_report_m" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="script_body" runat="Server">
   <script type="text/javascript">
	...
	//alert(Merchant);
                ...
                type: "get",
                async:false,
               data: { type: "35",match: match,venue: venue,To: To,From: From,Mode: Mode,Merchant: Merchant},
