<%@ Page Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="merchantbookingshome_list.aspx.vb" Inherits="merchantbookingshome_list" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="script_body" runat="Server">
   ...
   // alert(venuepsl);
	//  alert(event_idpsl);
                ...
                type: "get",
                async:false,
               data: { type: "33",venuepsl: venuepsl,event_idpsl:event_idpsl},
