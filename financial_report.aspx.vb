...
Partial Class financial_report
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
		If Session("user_id_psl") = "37" or Session("user_id_psl") = "39" or Session("user_id_psl") = "75" or Session("user_id_psl") = "73" or Session("user_id_psl") = "86" or Session("user_id_psl") = "87" or Session("user_id_psl") = "93" Then
 Server.Transfer("index.aspx")
End IF
'If Session("user_id_psl") <> "89" and Session("user_id_psl") <> "81" and Session("user_id_psl") <> "82" and Session("user_id_psl") <> "83" Then
 'Server.Transfer("index.aspx")
'End IF
