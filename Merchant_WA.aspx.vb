...
If Session("user_id_psl") <> "86"  Then
 Server.Transfer("index.aspx")
End IF
       ...
       'End If
        ...
        If Not Me.IsPostBack Then
            ...
            Using con1 As New SqlConnection(constr)
                Using cmdd As New SqlCommand("select [Email],[AdminUserId] from AdminUsers where [SuperAdminIDD]='wakharesta@360-nautica.com'")
          ...
          Dim sqlcmd As SqlCommand, sqlcon As New SqlConnection(constr), ds As New DataSet, sqldata As New SqlDataAdapter
               ...
               Try
                   ...
                   With sqlcmd
        			   ...
        			   .Parameters.Add("@user_id", Data.SqlDbType.varchar, 100).Value = "86"
                       sqldata.SelectCommand = sqlcmd
                       sqldata.Fill(ds)
                       GridView2.DataSource = ds.Tables(0)
                       GridView2.DataBind()
